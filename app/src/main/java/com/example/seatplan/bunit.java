...
public class bunit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        esearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(bunit.this,bresult.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                Intent intent=new Intent(bunit.this,MainActivity.class);
                startActivity(intent);
        }
        ...
        {
            case R.id.people:
                Intent intent=new Intent(bunit.this,about_me.class);
                startActivity(intent);
