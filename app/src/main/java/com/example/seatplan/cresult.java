...
public class cresult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serchagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(cresult.this,cunit.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                Intent intent=new Intent(cresult.this,MainActivity.class);
                startActivity(intent);
        }
        ...
        {
            case R.id.people:
                Intent intent=new Intent(cresult.this,about_me.class);
                startActivity(intent);
