...
public class aunit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        esearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(aunit.this,aresult.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                Intent intent=new Intent(aunit.this,MainActivity.class);
                startActivity(intent);
        }
        ...
        {
            case R.id.people:
                Intent intent=new Intent(aunit.this,about_me.class);
                startActivity(intent);
